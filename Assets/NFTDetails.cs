...
public class NFTDetails : MonoBehaviour
{
  ...
  void Start()
  {
    detailpanel = GameObject.FindGameObjectWithTag("Canvas").transform.GetChild(5).gameObject;
  }
  ...
  public void ShowAndSendDatatoUI()
  {
    ...
    detailpanel.transform.GetChild(0).GetChild(0).GetChild(0).GetChild(2).GetComponent<TextMeshProUGUI>().text = "Max Speed: " + maxSpeed;
    ...
    detailpanel.transform.GetChild(0).GetChild(0).GetChild(0).GetChild(5).GetComponent<TextMeshProUGUI>().text = "Steering Power: " + steeringPower;
